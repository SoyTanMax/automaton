...
export function Button({ children, variant, onClick, className, type }: Props) {
    const baseStyle = `flex items-center gap-2 justify-center inline-block text-sm px-5 py-2.5 text-center font-medium text-gray-900 rounded-lg bg-cyan-300 
    ...
    const secondaryStyle = `flex items-center gap-2 justify-center inline-block text-sm px-5 py-2.5 text-center font-medium text-gray-900 rounded-lg bg-white 
      focus:outline-none focus:ring-4 focus:ring-blue-300 
      dark:focus:ring-blue-800 
      hover:bg-gray-100 
      dark:bg-gray-200 dark:hover:bg-gray-300`
    
    const textStyle = `flex items-center gap-2 justify-center inline-block text-sm px-0 py-0 text-center text-neutral-100 bg-transparent
      focus:outline-none focus:ring-4 focus:ring-blue-300 
      dark:focus:ring-blue-800 
